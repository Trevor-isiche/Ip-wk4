    ...
    $("button#continue").click(function (event) {
      ...
      // add button
       $("button#add").click(function(){
        ...
        $("#inputorder").append(`<tr><td id="pizzatype">`+newOrder.name +`</td><td id="pizzasize"> `+ newOrder.size +`</td><td id="pizzacrust"> `+ newOrder.crust +`</td><td id="pizzatopping"> `+ newOrder.topping +`</td><td id="totals"> `+ newOrder.total +`</td></tr>`);
